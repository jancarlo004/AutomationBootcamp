...
public class GtApiBridge {
    ...
    public static Map<String, Object> executeGtApiScenario(
        ...
        // Use GW Runner to work around Karate 1.3 scenario execution bug
        return Runner.executeScenario(featureFilePath, scenarioTagToExecute, args);
    }
    ...
    public static Map<String, Object> executeGtApiFeature(String featureFilePath, Map<String, Object> args) {
        ...
        StringUtils.Pair pathAndTag = FileUtils.parsePathAndTags(featureFilePath);
        return Runner.executeScenario(pathAndTag.left, pathAndTag.right, args);
    }
