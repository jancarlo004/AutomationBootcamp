...
class UiApiBridge {
    constructor() {
        ...
        if(!supportingJarsIncluded) {
            ...
            java.classpath.push(path.resolve(__dirname, apiIntegrationSupportingLibsLoc + 'logback-classic-1.3.11.jar'));
            java.classpath.push(path.resolve(__dirname, apiIntegrationSupportingLibsLoc + 'log4j-core-2.17.1.jar'));
